    ...
    while True:
        ...
        if len(result_boxes) > 0:
            ...
            for i,r in enumerate(result_boxes):
                ...
                org = (int(r[0]),int(r[1]))
                cv2.rectangle(frame, (int(r[0]),int(r[1])), (int(r[2]),int(r[3])), (255,0,0), 2)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-w','--weights', type=str, default='custom_plate.tflite', help='model.tflite path(s)')
